...
- **Whence the Mathematical Universe** <div id="wmuh"></div> *Philosophy of Science* - The article listed here represents a more mature appraisal of Tegmark's Mathematical Universe Hypothesis - it includes an important survey of many important but lesser-known philosophical and mathematical ideas. Later, I argue that the assumptions built into MUH aren't very good but show an alternative approach that would lead one to Pythagoreanism anyway - that we need to blend these two into a better hierarchy of ontological concept.
